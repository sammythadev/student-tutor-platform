# Graph Report - project  (2026-09-03)

## Corpus Check
- 505 files · ~509,475 words
...
2. `AppDatabase` - 60 edges
3. `scripts` - 40 edges
4. `CORE DIRECTIVE: PREMIUM MOBILE APP IMAGE DIRECTION` - 39 edges
5. `CurrentUser` - 36 edges
6. `compilerOptions` - 29 edges
7. `MatchmakingService` - 22 edges
...
- `DataTable()` --calls--> `columnWidths()`  [EXTRACTED]
...
### Community 0 - "scripts"
Cohesion: 0.05
Nodes (40): scripts, build, build:dev, build:minified, clean, commitlint, db:generate, db:migrate (+32 more)
...
Cohesion: 0.15
Nodes (9): AuthService, Injectable, Inject, Injectable, UsersRepository, Injectable, UsersService, toPublicUserWithProfiles() (+1 more)
...
Cohesion: 0.06
Nodes (32): API, Auth, Dashboard, `GET /auth/verify`, `GET /dashboard/admin-metrics`, `GET /dashboard/metrics`, `GET /dashboard/tutor-metrics`, `GET /matchmaking/assignments/me?page=1&limit=10` (+24 more)

### Community 12 - "cookie-parser"
Cohesion: 0.09
Nodes (25): ScheduleSlotRecord, scheduleSlots, SchedulingController, ApiBearerAuth, ApiBody, ApiOperation, ApiParam, ApiQuery (+17 more)

### Community 14 - "crypto-js"
Cohesion: 0.14
Nodes (19): BROWSER_KEYS, CLI_FLAG_ROWS, GLOBAL_KEYS, HELP_SECTIONS, HelpRow, HelpSection, isHelpCloseChord(), MENU_KEYS (+11 more)

### Community 28 - "swagger-ui-express"
Cohesion: 0.06
Nodes (51): Roles(), student(), DashboardController, ApiBearerAuth, ApiOperation, ApiResponse, ApiTags, Controller (+43 more)

### Community 33 - "eslint-config-prettier"
Cohesion: 0.08
...
### Community 34 - "@eslint/eslintrc"
Cohesion: 0.14
Nodes (6): sessions, SessionsRepository, Inject, Injectable, SessionsService, Injectable

### Community 36 - "globals"
Cohesion: 0.18
Nodes (11): devDependencies, eslint-config-prettier, @eslint/eslintrc, @swc/jest, ts-prune, @types/express, eslint-config-prettier, @eslint/eslintrc (+3 more)
...
Cohesion: 0.15
Nodes (18): Input(), MessageModal(), MessageModalProps, formatTime(), NotificationCard(), NotificationDetail(), NotificationsPanel(), NotificationsPanelProps (+10 more)

### Community 49 - "@swc/jest"
Cohesion: 0.22
Nodes (12): ALL_BOOL_FLAGS, ALL_VALUE_FLAGS, CANONICAL_TARGET, IGNORED_BOOL_FLAGS, IGNORED_VALUE_FLAGS, isTargetToken(), parseTuiArgs(), SCREEN_NAMES (+4 more)

### Community 51 - "ts-loader"
Cohesion: 0.11
Nodes (25): AC, ACCENT_COLORS, AccentKey, addDays(), CalView, chipColor(), DAYS_FULL, DAYS_SHORT (+17 more)

### Community 52 - "ts-node"
Cohesion: 0.20
Nodes (9): 100 runs per test, every run its own row (all 4 strategies + per-run time):, Environment, Eval TUI, Launch, Scripts, Setup, Stack, Structure (+1 more)
...
### Community 56 - "@types/express"
Cohesion: 0.24
Nodes (7): AuthTokenService, Injectable, AuthTokenClaims, AuthTokenPair, TokenUse, getJwtAccessTokenTtlSeconds(), getJwtRefreshTokenTtlSeconds()

### Community 57 - "@types/jsonwebtoken"
Cohesion: 0.13
Nodes (15): ACTIVITY_ICON, ActivityFeed(), EASE, formatSessionTime(), IDENTITY_BG, KPI_FALLBACK_ACCENT, KPI_ICON, RecentSessionsTable() (+7 more)

### Community 60 - "typescript"
Cohesion: 0.14
Nodes (26): NEST_TO_WINSTON, PinoFactory, stringifyMeta(), AppEnvironment, ENVIRONMENT_FILES, getAdminSignupCode(), getAppEnvironment(), getAppName() (+18 more)
...
Cohesion: 0.20
Nodes (4): AlgorithmWeights, AlgorithmWeightsInput, CriterionWeights, CriterionWeightsInput

### Community 66 - "Roles"
Cohesion: 0.10
Nodes (19): ApiProperty, ApiPropertyOptional, DashboardRepository, Injectable, DashboardService, dayWindow(), pctDelta(), Injectable (+11 more)
...
Cohesion: 0.15
Nodes (29): CurrentUser, BookSessionDto, ProposeSessionDto, SessionParamDto, SessionResponseDto, SessionStatus, TransferSessionDto, ApiProperty (+21 more)

### Community 69 - "index.ts"
Cohesion: 0.10
Nodes (20): ACCENT_SET, ACTIVITY_ICON, ActivityFeed(), EASE, formatDayTime(), formatShortDate(), formatTime(), IDENTITY_BG (+12 more)

### Community 70 - "schema.ts"
Cohesion: 0.06
Nodes (34): assignments, assignmentStatusEnum, deliveryModeEnum, formatPreferenceEnum, learningPaceEnum, learningStyleEnum, MessageRecord, NewMessageRecord (+26 more)
...
Cohesion: 0.09
Nodes (22): API Endpoints, Architecture Flow, Assignment Algorithm (Lazy Greedy), Baseline comparison (`eval:baselines`), CLI: Evaluation Scripts, Commands, Component Architecture, Core Matchmaking Engine (+14 more)
...
Cohesion: 0.28
Nodes (5): AuthenticatedRequest, CommonExceptionFilter, ErrorResponseBody, isLoggingEnabled(), Catch

### Community 78 - "greedy-assignment.engine.ts"
Cohesion: 0.13
Nodes (15): 4.11 Discussion, 4.1.1 Hardware and Software Stack, 4.1 Analysis of Data Collection, 4.3.1 Schema Design, 4.3 Database Design, 4.4.1 Backend Module Architecture, 4.4.2 Consumption of the Matching Endpoint, 4.4 Module Design (+7 more)

### Community 79 - "CompositeScorer"
Cohesion: 0.29
Nodes (5): CancellationResult, AssignBatchOptions, AssignmentRunResult, AssignmentStats, CandidatePair

### Community 80 - "feed.repository.ts"
Cohesion: 0.11
Nodes (18): paths, @app/*, @common/*, @config, @configs/*, @core/*, @database, @modules/* (+10 more)
...
### Community 85 - "PreferenceScorer"
Cohesion: 0.18
Nodes (10): 3.1 Requirements Gathering, 3.2 Developing an Algorithm to Match Students with Tutors Based on Established Criteria, 3.3 Implementation Plan, ABSTRACT, APPENDIX, Appendix A: Source Code, Appendix B: Corrections Log — Seminar Proposal to Implemented System, Appendix C: Provenance of the Test Suite and Evaluation Figures (+2 more)
...
Cohesion: 0.18
Nodes (13): AuthSignupDto, ApiProperty, IsEmail, IsEnum, IsString, MinLength, LearningStylePreference, _roleParity (+5 more)
...
### Community 90 - "EligibilityFilter"
Cohesion: 0.12
Nodes (16): compilerOptions, declaration, incremental, module, moduleResolution, noEmit, exclude, extends (+8 more)
...
Cohesion: 0.10
Nodes (21): @base-ui/react, clsx, dependencies, axios, @base-ui/react, clsx, geist, motion (+13 more)

### Community 102 - "@types/node"
Cohesion: 0.11
Nodes (19): dotenv-cli, devDependencies, dotenv-cli, postcss, shadcn, tailwindcss, @tailwindcss/postcss, @types/node (+11 more)

### Community 103 - "@types/pg"
Cohesion: 0.21
Nodes (10): AppHeader(), footerNavLinks, isNavPathActive(), navGroups, navLinks, SidebarNavGroup, SidebarNavItem, NavGroup() (+2 more)
...
Cohesion: 0.08
Nodes (12): BENTO_CELLS, CASCADE, HOW_STEPS, LandingPage(), NAV_LINKS, SPRING, STATS, SUBJECT_LOGOS (+4 more)
...
Cohesion: 0.14
Nodes (14): DeliveryMode, FormatPreference, LearningPace, TeachingStyle, CandidatePageResponse, CandidateQuery, FeedbackPayload, FeedbackResult (+6 more)

### Community 117 - "auth.service.ts"
Cohesion: 0.13
Nodes (13): accentForId(), CatalogCard(), CatalogCardAction, CatalogCardData, initialsOf(), Badge(), badgeVariants, accentFor() (+5 more)

### Community 118 - "UpdateStudentPreferencesDto"
Cohesion: 0.17
Nodes (15): NotificationPrefsDto, ApiPropertyOptional, IsArray, IsEnum, IsInt, IsNumber, IsOptional, IsString (+7 more)
...
Cohesion: 0.11
Nodes (17): AvailabilitySlot, login(), LoginPayload, mapSession(), signup(), SignupPayload, StudentOnboardPayload, TutorOnboardPayload (+9 more)
...
Cohesion: 0.12
Nodes (11): BaselineRow, BaselineScenario, HEADER, jain(), Picker, runAllStrategies(), runBaselineCell(), runBaselineComparison() (+3 more)
...
Cohesion: 0.15
Nodes (12): name, hono, pnpm, overrides, private, scripts, build, dev (+4 more)

### Community 144 - "PinoLikeLogger"
Cohesion: 0.22
Nodes (6): CLEAR_RE, ERASE_RE, ESC, fakeStdin, FakeStdout, instance
...
Cohesion: 0.53
Nodes (5): cursorPosition, indexFromPosition(), VisualSpan, visualSpans(), wrapText()

### Community 166 - "@types/jest"
Cohesion: 0.28
Nodes (8): CORE_DIR, findFile(), isTypeScriptPath(), load(), PROJECT_ROOT, resolve(), SOURCE_SUFFIXES, SWC_CONFIG

### Community 173 - "gsap"
Cohesion: 0.05
Nodes (43): 1. Instantiate the Engine, 2. Match a Batch of Students, 2a. Eligibility Filter — The Bouncer, 2b. Scorers — The Judge, 2c. Top-K Ranker — The Sorter, 2d. Greedy Assignment Engine — The Matchmaker, 2e. Feedback Updater — The Learner, 2f. Weight Adaptation — The Tuner (+35 more)

### Community 175 - "react-dom"
Cohesion: 0.10
Nodes (20): aliases, components, hooks, lib, ui, utils, iconLibrary, registries (+12 more)

### Community 177 - "@types/three"
Cohesion: 0.12
Nodes (15): Animations, Buttons & badges, Cards, Colours / tokens, Core visual grammar, Delta badges, DO NOT, Empty states — CRITICAL (+7 more)

### Community 178 - "@vercel/analytics"
Cohesion: 0.20
Nodes (9): compilerOptions, baseUrl, exclude, extends, ./tsconfig.json, dist, node_modules, **/*spec.ts (+1 more)

### Community 179 - "zustand"
Cohesion: 0.40
Nodes (3): fakeStdin, FakeStdout, instance

### Community 180 - "AuthSignupDto"
Cohesion: 0.15
Nodes (11): container, DashboardHeroProps, EASE, headline, HeroAction, HeroStat, passThrough, rise (+3 more)

### Community 181 - "TutorDashboard.tsx"
Cohesion: 0.24
...
Cohesion: 0.16
Nodes (22): capacityForIndex(), CapacityStrategy, DELIVERY_MODES, EXAM_TYPES, FORMATS, generateStudents(), generateTutors(), LEARNING_STYLES (+14 more)
...
Cohesion: 0.22
Nodes (9): LANGUAGES, OnboardingPage(), Role, Screen, Stage, STUDENT_STAGES, SUBJECTS, TUTOR_STAGES (+1 more)
...
Cohesion: 0.18
Nodes (10): Current Task, Entry Template, Result, Task: Eval TUI help UI, Task: Fix help panel not closing (stale rows stuck on screen), Task: Honest eval fixtures + Gale-Shapley baseline, Task: HTTP Logging + Global Exception Filter + Env-Driven Log Config, Task: Interactive eval TUI (Ink) (+2 more)
...
### Community 189 - "PreferenceScorer"
Cohesion: 0.11
Nodes (16): IDENTITY_BG, ProfilePage(), ProfileResponse, STATUS_DOT, notificationRows, Dropdown(), DropdownOption, DropdownProps (+8 more)
...
Cohesion: 0.18
Nodes (12): CustomSidebarTrigger(), ThemeToggle(), Kbd(), KbdGroup(), Tooltip(), TooltipContent(), TooltipProvider(), TooltipTrigger() (+4 more)
...
### Community 201 - "layout.tsx"
Cohesion: 0.17
Nodes (11): 1. Visual Theme & Atmosphere, 2. Color Palette & Roles, 3. Typography Rules, 4. Component Stylings, 5. Layout Principles, 6. Motion & Interaction, 7. Section Structure (Top to Bottom), 8. Anti-Patterns (Banned) (+3 more)

### Community 202 - "Modal.tsx"
Cohesion: 0.19
Nodes (5): ModalProps, Dialog(), DialogContent(), DialogHeader(), DialogTitle()

### Community 203 - "bcrypt"
Cohesion: 0.25
Nodes (6): AppBreadcrumbPage, AppBreadcrumbs(), Breadcrumb(), BreadcrumbItem(), BreadcrumbList(), BreadcrumbPage()

### Community 204 - "baseline-comparison.ts"
Cohesion: 0.24
...
### Community 209 - "motion"
Cohesion: 0.25
Nodes (8): Animate enter states with @starting-style, Buttons must feel responsive, Component Building Principles, Make popovers origin-aware, Never animate from scale(0), Tooltips: skip delay on subsequent hovers, Use blur to mask imperfect transitions, Use CSS transitions over keyframes for interruptible UI

### Community 212 - ".getTutorSlots"
Cohesion: 0.33
Nodes (6): 1. Should this animate at all?, 2. What is the purpose?, 3. What easing should it use?, 4. How fast should it be?, Perceived performance, The Animation Decision Framework

### Community 221 - "NotificationsPanel.tsx"
Cohesion: 0.33
Nodes (6): clip-path for Animation, Comparison sliders, Hold-to-delete pattern, Image reveals on scroll, Tabs with perfect color transitions, The inset shape

### Community 222 - "jwt-refresh.strategy.ts"
Cohesion: 0.33
Nodes (6): CSS animations beat JS under load, CSS variables are inheritable, Framer Motion hardware acceleration caveat, Only animate transform and opacity, Performance Rules, Use WAAPI for programmatic CSS animations

### Community 224 - "Findings"
Cohesion: 0.33
Nodes (5): Eval TUI architecture (2026-08), Findings, ink v4 gotchas, Suite registry, TUI v2: banner + scratchpad (2026-08)

### Community 236 - "StudentList.tsx"
Cohesion: 0.29
...
### Community 243 - "CurrentUser"
Cohesion: 0.11
Nodes (17): AuthenticatedRequest, AuthGuard, Injectable, AccountRole, AuthenticatedUser, AuthenticatedRequest, JwtAccessStrategy, Injectable (+9 more)

### Community 244 - "MatchmakingTestController"
Cohesion: 0.11
Nodes (23): ApiBearerAuth, ApiBody, ApiOperation, ApiParam, ApiResponse, ApiTags, CommonModule, Module (+15 more)

### Community 245 - "Evaluation Findings — Final Authoritative Run"
Cohesion: 0.25
Nodes (7): 1. Test suite, 2. Match quality and fairness (Table 4.4 of the report), 3. Effect of the fairness weight (Table 4.5 of the report), 4. Performance benchmarking (Table 4.6 of the report), 5. Comparison with baseline assignment (Table 4.7 of the report), 6. Optimality gap (Section 4.5.5 of the report), Evaluation Findings — Final Authoritative Run

### Community 246 - "getJwtAccessTokenPublicKey"
Cohesion: 0.40
Nodes (5): 3D transforms for depth, CSS Transform Mastery, scale() scales children too, transform-origin, translateY with percentages

### Community 247 - "CHAPTER ONE"
Cohesion: 0.22
Nodes (9): 1.1 Background to the Study, 1.2 Statement of Problem, 1.3 Objectives of the Study, 1.4 Research Questions, 1.5 Scope of the Study, 1.6 Limitations of the Study, 1.7 Significance of the Study, 1.8 Definition of Terms (+1 more)

### Community 248 - "4.10 Results and Evaluation"
Cohesion: 0.29
Nodes (7): 4.10.1 Evaluation Harness, 4.10.2 Match Quality and Fairness, 4.10.3 Effect of the Fairness Weight, 4.10.4 Performance Benchmarking, 4.10.5 Comparison with Baseline Assignment Strategies, 4.10.6 Explainability, 4.10 Results and Evaluation

### Community 249 - "CHAPTER TWO"
Cohesion: 0.33
Nodes (6): 2.1 Conceptual Framework, 2.2 Theoretical Framework, 2.3 Empirical Framework, 2.4 Summary of Literature Review, CHAPTER TWO, Research Gap

### Community 250 - "4.5 Algorithm Design and Complexity Analysis"
Cohesion: 0.33
Nodes (6): 4.5.1 Composite Scoring Model, 4.5.2 Priority-Queue Greedy Assignment Algorithm, 4.5.3 Time Complexity Analysis, 4.5.4 Space Complexity Analysis, 4.5.5 Empirical Validation Against the True Optimum, 4.5 Algorithm Design and Complexity Analysis

### Community 251 - "CHAPTER FIVE"
Cohesion: 0.33
Nodes (6): 5.1 Summary of Findings, 5.2 Conclusions, 5.3 Recommendations, 5.4 Contribution to Knowledge, 5.5 Future Work, CHAPTER FIVE

### Community 252 - "4.9 Testing Strategy"
Cohesion: 0.50
Nodes (4): 4.9.1 Unit Testing Approach, 4.9.2 Edge Case Verification, 4.9.3 Test Execution, 4.9 Testing Strategy

### Community 253 - "4.2 System Architecture"
Cohesion: 0.67
Nodes (3): 4.2.1 Three-Tier Architecture, 4.2.2 Core Algorithm Architecture (Domain Layer), 4.2 System Architecture

### Community 254 - "The Sonner Principles (Building Loved Components)"
Cohesion: 0.40
Nodes (5): Asymmetric enter/exit timing, Cohesion matters, Review your work the next day, The opacity + height combination, The Sonner Principles (Building Loved Components)

### Community 255 - "Spring Animations"
Cohesion: 0.40
Nodes (5): Interruptibility advantage, Spring Animations, Spring-based mouse interactions, Spring configuration, When to use springs

### Community 257 - "RefreshTokenDto"
Cohesion: 0.50
Nodes (3): RefreshTokenDto, ApiProperty, IsJWT

### Community 258 - "Core Philosophy"
Cohesion: 0.50
Nodes (4): Beauty is leverage, Core Philosophy, Taste is trained, not innate, Unseen details compound

### Community 259 - "Debugging Animations"
Cohesion: 0.50
Nodes (4): Debugging Animations, Frame-by-frame inspection, Slow motion testing, Test on real devices

### Community 261 - ".shot.mjs"
Cohesion: 0.50
Nodes (3): errors, height, width

### Community 298 - "app-logger.service.ts"
Cohesion: 0.25
Nodes (7): compilerOptions, baseUrl, ignoreDeprecations, module, moduleResolution, extends, ./tsconfig.json

### Community 299 - "channel-sales-chart.tsx"
Cohesion: 0.11
...
### Community 300 - "dashboard.ts"
Cohesion: 0.08
Nodes (26): AdminPage(), EASE, IDENTITY_BG, MetricCard, ACCENT_COLORS, CalendarEvent, CalendarGrid(), CalendarGridProps (+18 more)

### Community 301 - "DashboardPreview.tsx"
Cohesion: 0.15
Nodes (8): MATCHES, SERIES, StatRow(), TILES, TOTAL, UPCOMING, WEEK, WEEK_PEAK

### Community 302 - "page.tsx"
Cohesion: 0.21
Nodes (9): Composer(), FeedPage(), Filter, FILTERS, nameInitials(), parseTags(), PostCard(), SHORTCUTS (+1 more)

### Community 303 - "page.tsx"
Cohesion: 0.27
Nodes (11): Avatar(), Bubble(), clockTime(), DayDivider(), dayLabel(), listStamp(), MessagesPage(), sameDay() (+3 more)

### Community 304 - "GradualBlur.tsx"
Cohesion: 0.24
Nodes (11): CURVE_FUNCTIONS, debounce(), DEFAULT_CONFIG, getGradientDirection(), GradualBlur(), GradualBlurMemo, GradualBlurProps, mergeConfigs() (+3 more)

### Community 305 - "LogoLoop.tsx"
Cohesion: 0.17
Nodes (6): ANIMATION_CONFIG, LogoImageItem, LogoItem, LogoLoop, LogoLoopProps, LogoNodeItem

### Community 306 - "chart-empty.tsx"
Cohesion: 0.20
Nodes (7): ChartEmpty(), GHOST_BARS, GHOSTS, buildConfig(), PIE_COLORS, PieDatum, SubjectMixChart()

### Community 308 - "chart.tsx"
Cohesion: 0.33
Nodes (4): fromRefreshTokenBody(), JwtRefreshStrategy, Injectable, getJwtRefreshTokenPublicKey()

### Community 309 - "sheet.tsx"
Cohesion: 0.18
Nodes (5): Sheet(), SheetContent(), SheetDescription(), SheetHeader(), SheetTitle()

### Community 311 - "app-shell.tsx"
Cohesion: 0.38
Nodes (3): AppShell(), AppSidebar(), SidebarInset()

### Community 312 - "greeting.ts"
Cohesion: 0.47
Nodes (5): Band, bandFor(), BANDS, timeOfDayGreeting(), useTimeOfDayGreeting()

### Community 316 - "LaserFlow.tsx"
Cohesion: 0.67
Nodes (3): hexToRGB(), LaserFlow(), Props

### Community 318 - "CalendarGrid.tsx"
Cohesion: 0.53
Nodes (5): StudentProfileRecord, TutorProfileRecord, UserRecord, PublicUserRecord, UserWithProfilesRecord

### Community 323 - "Button.tsx"
Cohesion: 0.67
