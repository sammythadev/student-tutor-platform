...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Smart Matching</span> <span className="text-primary/60">✦</span>
    <span>Expert Tutors</span> <span className="text-secondary/60">✦</span>
    <span>Flexible Scheduling</span> <span className="text-primary/60">✦</span>
    <span>Proven Results</span> <span className="text-secondary/60">✦</span>
    <span>Global Community</span> <span className="text-primary/60">✦</span>
  </div>
);
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              <div className="flex flex-wrap justify-center gap-4 w-full">
                ...
                <MagneticButton as="a" href="/tutors" className="footer-glass-pill px-10 py-5 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-3 group">
                  Browse Tutors
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </MagneticButton>
              </div>
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-border/50">
              ...
              <span className="text-foreground font-black text-xs md:text-sm tracking-normal ml-1">Tutorly</span>
            </div>
